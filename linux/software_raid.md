...
- [Создание RAID-массива](#create_raid)
	- [Проверка правильности сборки](#check_raid)
	- [Создание файловой системы поверх RAID-массива](#create_fs_on_raid)
	- [Создание mdadm.conf](#mdadm.conf)
- [Автомонтирование RAID](#automount_raid)
- [Обслуживание RAID](#service_raid)
	- [Мониторинг состояния](#monitoring)
	- [Замена сбойного диска](#замена-сбойного-диска)
		- [1. Пометка диска как сбойного](#zamena_1)
		- [2. Удаление сбойного диска](#zamena_2)
		- [3. Выключаем машину, меняем диск.](#zamena_3)
		- [4. Подготовка нового жесткого диска](#zamena_4)
		- [5. Добавление нового диска](#zamena_5)
- [Links](#links)
